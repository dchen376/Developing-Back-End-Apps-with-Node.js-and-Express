...
- You will fork the skeleton code into your own repository, clone it locally into your development environment, and develop the code further.  
- Implement **CRUD capabilities** using HTTP methods in your Express server.  
- Test API endpoints using **Postman**.  
- Implement **Session and JWT authentication** to allow only logged-in users to perform certain operations.  
- The application comes **preloaded with all book information**.  
- Enhance your code using **Promises, Callbacks, or Async/Await** to support multiple users interacting with the application simultaneously.  
